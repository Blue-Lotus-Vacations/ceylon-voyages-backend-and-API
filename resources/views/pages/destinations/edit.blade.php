        ...
        <section class="bg-white dark:bg-gray-900">
            ...
            <div class="py-8 px-4 mx-auto lg:py-16">
                ...
                <div class="items-center space-x-3 py-5">
                    <h5 class="dark:text-white font-semibold">Edit Category</h5>
                </div>
                ...
                <form action="{{ route('destination.update' ,$destination?->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <x-destination-form :destination=$destination :languages=$languages :destination_categories=$destination_categories :highlights=$highlights :visit_times=$visit_times :worth_visit=$worth_visit :food=$food :culture=$culture/>
