        ...
        <section class="bg-white dark:bg-gray-900">
            ...
            <div class="py-8 px-4 mx-auto lg:py-16">
                ...
                <div class="items-center space-x-3 py-5">
                    <h5 class="dark:text-white font-semibold">Create a New Destination</h5>
                </div>

                <form action="{{ route('destination.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    
                    <x-destination-form :destination_categories=$destination_categories :languages=$languages/>
