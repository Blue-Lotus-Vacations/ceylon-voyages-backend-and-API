        ...
        <section class="bg-white dark:bg-gray-900">
            ...
            <div class="py-8 px-4 mx-auto lg:py-16">
                ...
                <div class="items-center space-x-3 py-5">
                    <h5 class="dark:text-white font-semibold">Edit Destination Category</h5>
                </div>

                <form action="{{ route('destination_category.update' ,$destination_category?->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')

                    <x-destination-category-form :destination_category=$destination_category :languages=$languages/>
