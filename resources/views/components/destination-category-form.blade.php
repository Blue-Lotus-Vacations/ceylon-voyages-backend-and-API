            ...
            <div class="space-y-4 sm:space-y-6">
                ...
                <div class="space-y-4 sm:flex sm:space-x-4 sm:space-y-0">
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" value="{{ old('destination_category_name', $destination_category->destination_category_name ?? '') }}"
                            name="destination_category_name" id="destination_category_name"
